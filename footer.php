<footer class="footer">
			...
			<div class="footlogo"><a href="/" class="header__logo"><span class="logofoot"><?php echo get_field('text_logo', 'option');?></span></a></div>
			<div class="social social--mobile">
                        ...
                        <ul class="social__list">
                           ...
                           <li class="social__item"><a href="#" class="social__link  social__link-twitter"><img src="/wp-content/themes/bestphotoeditorstheme/img/icon-twitter.svg" alt=""></a></li>
                           ...
                           <li class="social__item"><a href="#" class="social__link  social__link-youtube"><img src="/wp-content/themes/bestphotoeditorstheme/img/icon-youtube.svg" alt=""></a></li>
                  ...
                  <div class="col-lg-1 d-lg-flex footer__column-social">
                     ...
                     <div class="social social--desktop">
                        ...
                        <ul class="social__list">
	                        ...
	                        ?>
                           <li class="social__item"><a href="<?php echo $link;?>" class="social__link  social__link-<?php echo $select;?>"><img src="/wp-content/themes/bestphotoeditorstheme/img/icon-<?php echo $select;?>.svg" alt=""></a></li>
               ...
               <div class="footer__bottom">
                  ...
                  © 2020. All rights reserved <span class="accent-text">BestPhotoEditors.net.</span>
